...
-moz-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);">   
                ...
                <div class="form-group">
					...
					<label>Full Name</label><br/>
                 	<input type="text" name="fullname" style="width:100%; height: 40px;" value="<?php echo($old['fullname']) ?>" /><br/><br/>
				</div> 
                
                <div class="form-group">
					
					<label>Address</label><br/>
                 	<input type="text" name="address" style="width:100%; height: 40px;" value="<?php echo($old['address']) ?>" /><br/><br/>
				</div>  
                ...
                <div class="form-group">
					...
					<label>City</label><br/>
                 	<input type="text" name="city" style="width:100%; height: 40px;" value="<?php echo($old['city']) ?>" /><br/><br/>
				</div>
				
				<div class="form-group">
					
					<label>Phone Number</label><br/>
                 	<input type="text" name="phonenumber" style="width:100%; height: 40px;" value="<?php echo($old['phonenumber']) ?>" /><br/><br/>
				</div>
				
				<div class="form-group">
					
					<label>Email</label><br/>
                 	<input type="text" name="email" style="width:100%; height: 40px;" value="<?php echo($old['email']) ?>" /><br/><br/>
				</div>
                
				<div class="form-group">
				  <label class="col-sm-3 control-label">Comment</label><br/><br/>
				  <div class="col-sm-6"><textarea style="width:400px" rows="4" cols="50" name="comment" class="form-control" type="text"><?php echo $old['comment']; ?></textarea></div>
				</div>
