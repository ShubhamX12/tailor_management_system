...
-moz-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);">   
					...
					<select name="customer" class="form-control" style="width:100%">
...
?>
                ...
                <div class="form-group">
					...
					<label>Date Received</label><br/>
                 	<input type="date" name="date_received" style="width:100%; height: 40px;" /><br/><br/>
				</div>
                ...
                <div class="form-group">
					...
					<select name="received_by" class="form-control" style="width:100%;">
					<?php
                ...
                <div class="form-group">
					...
					<i class="fa fa-rupee"></i> <input type="text" name="amount" style="width:200px; height: 40px;" /><br/><br/>
				</div>
                <div class="form-group">
					
					<label>Paid</label><br/>
					<i class="fa fa-rupee"></i> <input type="text" -name="paid" style="width:100%; height: 40px;" /><br/><br/>
				</div>
				 <div class="form-group">
				 ...
				 <div class="form-group">
					...
					<label>Date to Collect</label><br/>
                 	<input type="date" name="date_collected" style="width:100%; height: 40px;" /><br/><br/>
				</div>
