...
?>								
					...
					<select name="customer" style="width:100%" class="form-control">
                    <?php
...
?>
                ...
                <div class="form-group">
					<label>Description</label>
                 	<input type="text"  class="form-control" style="width:100%" name="desc" style="width:200px; height: 40px;" value="<?php echo($old['description']) ?>" /><br/>
				</div>
                ...
                <div class="form-group">
					...
					<select name="received_by" style="width:100%" class="form-control">
					<?php
                ...
                <div class="form-group">
					...
					<i class="fa fa-rupee"></i> <input  class="form-control" style="width:100%" type="text" name="amount"   class="form-control" value="<?php echo($old['amount']) ?>"  /><br/>
				</div>
                
                <div class="form-group">
					
					<label>Paid</label><br/>
					<i class="fa fa-rupee"></i> <input  class="form-control" style="width:100%" type="text" name="paid"  value="<?php echo($old['paid']) ?>" /><br/>
				</div>
                
                <div class="form-group">
					
					<label>Date Received</label><br/>
                 	<input type="date" style="width:100%" name="date_received" style="width:200px; height: 40px;" value="<?php echo($old['date_received']) ?>" /><br/>
				</div>
                
                <div class="form-group">
					
					<label>Completed?</label><br/>
                 	<select name="completed" class="form-control" style="width:100%">
                ...
                <div class="form-group">
					...
					<label>Date to Collect</label><br/>
                 	<input type="date" name="date_collected" style="width:100%; height: 40px;" value="<?php echo($old['date_collected']) ?>" /><br/><br/>
				</div> 
