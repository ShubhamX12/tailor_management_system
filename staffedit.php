...
?>								
					...
					<select  name="stafftype" class="form-control" style="width:100%; height: 40px;">
                    <?php
...
?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
					...
					<i class="fa fa-rupee"></i><input   type="text" name="salary" style="width:100%; height: 40px;" value="<?php echo($old['salary']) ?>" /><br/><br/>
				</div>
