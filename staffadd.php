...
-moz-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);padding:30px" >
            <div class="row">
                <div class="col-lg-12">
...
?>
                ...
                <div class="form-group">
					...
					<label>Full Name</label><br/>
                 	<input type="text" name="fullname" style="width:100%; height: 40px;" /><br/><br/>
				</div>  
                
                <div class="form-group">
					
					<label>Address</label><br/>
                 	<input type="text" name="address" style="width:100%; height: 40px;" /><br/><br/>
				</div>    
                
                <div class="form-group">
					
					<label>Phone Number</label><br/>
                 	<input type="text" name="phonenumber" style="width:100%; height: 40px;" /><br/><br/>
				</div>
                
                <div class="form-group">
					
					<label>Salary</label><br/>
                    <i class="fa fa-rupee"></i><input type="text" name="salary" style="width:100%; height: 40px;" /><br/><br/>
				</div>
