...
-moz-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);">   
                <div class="form-group">
					...
					<label>Full Name</label><br/>
                 	<input type="text" class="form-control" name="fullname" style="width:100%; height: 40px;" />
			        <br>
					
					<label>Address</label><br/>
                 	<input type="text"  class="form-control" name="address" style="width:100%; height: 40px;" />
			        <br>
					
					<label>Phone Number</label><br/>
                 	<input type="text"  class="form-control"  name="phonenumber" style="width:100%; height: 40px;" />
				    <br>
					
					<label>City</label><br/>
                 	<input type="text"   class="form-control" name="city" style="width:100%; height: 40px;" />
			        <br>
					
					<label>Email</label><br/>
                 	<input type="text" class="form-control" name="email" style="width:100%; height: 40px;" />
			        <br>
