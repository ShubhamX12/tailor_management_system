...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
    ...
    <div class="pageheader" style="box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);
-webkit-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);
-moz-box-shadow: 2px 4px 14px 12px rgba(0,0,0,0.12);">
      <h2><i class="fa fa-cog"></i> Delete Income Category</h2>
    </div>
...
$res = $pdo->exec("DELETE FROM inccat WHERE id='".$did."'");
